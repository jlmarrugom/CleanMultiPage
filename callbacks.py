...
def apilado(datos,prueba,agrupacion, title, y_title, barmode='stack'):
    """
...
def generate_bar(barras_edad):
    if barras_edad=='PCR':
        fig1 = apilado(df_pcr,'RESULTADO PCR','EDAD', 'Resultados de la Prueba PCR por Edades', 'Conteo (Individuos)')
    else:
        fig1 = apilado(df_ser,'RESULTADO SEROLOGIA','EDAD',  'Resultados de la Prueba Serologia por Edades', 'Conteo (Individuos)')
